...
namespace lse {
	...
	void LSLog::Init() {
		...
		sSpdLogger->set_pattern("%^%H:%M:%S:%e [%P-%t] [%l!L] [%20s:%-4#] - %v%$");
	}

	void LSLog::Log(spdlog::source_loc loc,spdlog::level::level_enum lvl,const spdlog::memory_buf_t &buffer) {
